...
import hsn.ibt.linkedlist.LinkedListPrimitiveOperations;
import hsn.ibt.linkedlist.ReverseLinkedList;

import java.util.Arrays;

public class DataParsers extends LinkedListPrimitiveOperations {
    ...
    public static void hackerRankDataParserTotalListsWithListsAndLastPosition(Callable callable) {
        ...
        for (int i = 0; i < hackerRankDataArray[0]; i++) {
            ...
            LinkedListPrimitiveOperations.SinglyLinkedList singlyLinkedList = new SinglyLinkedList();
            ...
            singlyLinkedList.head = ReverseLinkedList.reverse(singlyLinkedList.head);

            int val = (int) callable.call(singlyLinkedList.head, positionFromTail);
